...
```
bash <(curl -Ls https://raw.githubusercontent.com/niiaco/3xui/master/install.sh)
```
...
```
bash <(curl -Ls https://raw.githubusercontent.com/niiaco/3xui/master/install.sh) v2.3.7
```
